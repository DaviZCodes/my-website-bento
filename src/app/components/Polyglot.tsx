    ...
    >
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="px-3 py-1 rounded-lg bg-[#fdaf67e3]  cursor-pointer whitespace-nowrap transition-all duration-160 hover:bg-[#F1BF00] hover:text-[#AA151B] shadow-[2px_2px_5px_1px_rgba(253,175,103,0.5)]
        ...
        <button
          ...
          className="px-3 py-1 rounded-lg bg-[#fdaf67e3] cursor-pointer whitespace-nowrap transition-all duration-160 hover:bg-[#EE1C25] hover:text-[#FFFF00] shadow-[2px_2px_5px_1px_rgba(253,175,103,0.5)]
        ...
        <button
          ...
          className="px-3 py-1 rounded-lg bg-[#fdaf67e3] cursor-pointer whitespace-nowrap transition-all duration-160 hover:bg-[#009739] hover:text-[#FEDD00] shadow-[2px_2px_5px_1px_rgba(253,175,103,0.5)]
