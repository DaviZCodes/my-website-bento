...
export default function Technologies() {
  ...
  return (
    ...
    hover:border-[#fdaf67e3] rounded-xl px-3 py-3 bg-[#f5e2b6] hover:bg-[#fdaf67e3]
     ...
     2xl:px-8 2xl:py-6 2xl:h-auto 2xl:overflow-hidden"
      onClick={openModal}
    >
      <div
        className={`flex-grow whitespace-nowrap ${getTextSize()} font-semibold text-sm 
