    ...
    <div>
      <div className="bg-white rounded-lg shadow-md py-6 pl-3 pr-3 text-center">
        ...
        <div className="text-gray-700 text-lg leading-7 lg:mx-10">
          Tomorrow will be the last day of winter break. I just arrived to NYC
          from Brazil. It is freezing here (-7 degrees celsius), while it was
          almost 30 in Brazil. I had a blast. I really miss my family.
          Hopefully, this semester I can learn a lot, get good grades, build
          strong relationships, improve myself, and perhaps even win the
